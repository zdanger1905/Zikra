    ...
    <div className="min-h-screen bg-[#3d3d3d]">
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 mb-4">Browse all 114 surahs</p>
          <Link
            href="/quran/identify"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#4a4a4a] hover:bg-[#555] border border-[#666] text-sm text-gray-300 hover:text-white transition-colors"
          >
