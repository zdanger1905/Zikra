...
export default function RecitationPage() {
  ...
  function placeHandle(ref: React.RefObject<HTMLDivElement | null>, wp: WordPos, side: "start" | "end") {
    ...
    ref.current.style.top  = (r.top + r.height / 2 - 8) + "px";
  ...
  return (
    <div className="min-h-screen bg-[#3d3d3d] flex">
      ...
      {/* ── Left: Surah list ── */}
      <div className="fixed left-0 top-12 bottom-0 w-64 bg-[#252525] border-r border-[#333] flex flex-col z-30">
      ...
      {/* ── Center: Arabic text ── */}
      <div className="ml-64 mr-56 min-h-screen pt-16 pb-28 px-14">
        {loading && (
      ...
      <div
        ...
        style={{
          ...
          zIndex: 60, cursor: "grab", userSelect: "none",
        }}
      />
      <div
        ref={endHandleRef}
      ...
      {/* ── Right: Player panel ── */}
      <div className="fixed right-0 top-12 bottom-0 w-56 bg-[#252525] border-l border-[#333] flex flex-col items-center pt-8 pb-6 px-5 gap-5 z-30 overflow-y-auto">
            ...
            <button
              onClick={() => {
                if (cursorsActive) {
                  ...
                  computeLoopTimes();
                  // Handle positions populated by useEffect after render
                }
              }}
